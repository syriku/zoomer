...
method MacWorkspacePlatformActual.screenRecordingPermission: WorkspacePermissionState;
begin
...
method MacWorkspacePlatformActual.requestScreenRecordingPermission;
begin
...
method MacWorkspacePlatformActual.openScreenRecordingSettings;
begin
  if not NSThread.isMainThread then begin
    NSOperationQueue.mainQueue.addOperationWithBlock(method
      begin
...
method MacWorkspacePlatformActual.captureDisplayWithRequestId(requestId: Int64) completion(completion: WorkspaceCaptureCompletion);
begin
...
method MacWorkspacePlatformActual.createWorkspaceSurface: IWorkspaceSurfaceActual;
begin
  result := new MacWorkspaceSurfaceActual;
end;

method MacWorkspacePlatformActual.screenContainingPointer: NSScreen;
begin
  var pointerLocation := NSEvent.mouseLocation;
...
method MacWorkspacePlatformActual.workspaceDisplayForScreen(screen: NSScreen): WorkspaceDisplay;
begin
...
method MacWorkspacePlatformActual.identifierForScreen(screen: NSScreen): String;
begin
...
method MacWorkspacePlatformActual.shareableDisplayInContent(content: SCShareableContent) atPoint(pointerLocation: NSPoint): SCDisplay;
begin
...
method MacWorkspacePlatformActual.completeFailureWithRequestId(requestId: Int64) code(failureCode: WorkspaceFailureCode) message(failureMessage: String) completion(completion: WorkspaceCaptureCompletion);
begin
...
method MacWorkspacePlatformActual.completeCaptureWithCompletion(completion: WorkspaceCaptureCompletion) captureResult(captureResult: WorkspaceCaptureResult);
begin
