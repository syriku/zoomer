...
method WindowsShellIntegration.startShell;
begin
...
method WindowsShellIntegration.updateWorkspaceState(state: WorkspaceState) statusText(text: String);
begin
...
method WindowsShellIntegration.stopShell;
begin
...
method WindowsShellIntegration.windowMessageHook(windowHandle: IntPtr) message(message: Int32) wParam(wParam: IntPtr) lParam(lParam: IntPtr) handled(var handled: Boolean): IntPtr;
begin
...
method WindowsShellIntegration.showContextMenu;
var
  cursorPoint: WindowsPoint;
begin
  if not assigned(fMessageSource) then
    exit;
...
method WindowsShellIntegration.notifyPresentationRequested;
begin
  if fWorkspaceState <> WorkspaceState.Idle then
    exit;
...
method WindowsShellIntegration.notifyQuitRequested;
begin
...
method WindowsShellIntegration.displayStatusText: String;
begin
...
method WindowsShellIntegration.removeTrayIcon;
begin
